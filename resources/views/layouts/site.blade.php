    ...
    <div class="main-wrapper">
        <div class="flex-container">
            <a class="logotipo" href="{{ route('home') }}">
                <img src="{{ asset('images/Asset1.svg') }}">                
            </a>
...
<div id="resize">
    <ul id="menu">
        ...
        <li><a class="title-medium" href="{{route('products')}}">Produtos</a></li>
        <li><a class="title-medium" href="{{route('blog')}}">Blog</a></li>
        <li><a class="title-medium" href="{{route('about')}}">Sobre</a></li>
        <li><a class="title-medium" href="{{route('contact')}}">Contato</a></li>
    </ul>
</div>
